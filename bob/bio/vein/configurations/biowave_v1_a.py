...
**This** ``bob.db.biowave_v1`` **database configuration that makes database to return only files (original images) that have annotations (for each hand in database ``3x2`` images).** More information - :py:class:`bob.bio.vein.database.BiowaveV1BioDatabase()`.
