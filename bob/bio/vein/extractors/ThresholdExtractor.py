...
class ThresholdExtractor(Extractor):
    """
    ...
    **Parameters:**
    ...
    thin_veins_flag : :py:class:`bool`
        Make the veins thin if set to True. Default -
        False
    """
    ...
    def __init__(self,
                 ...
                 median=False,
                 size=5,
                 thin_veins_flag = False
                 ):
        Extractor.__init__(self,
                           name=name,
                           median=median,
                           size=size,
                           thin_veins_flag = thin_veins_flag
                           )
        self.name = name
        self.median = median
        self.size = int(size)
        self.thin_veins_flag = thin_veins_flag
